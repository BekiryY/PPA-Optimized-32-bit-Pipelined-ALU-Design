...
read_hdl -sv {ALU_TOP.sv ADDER32_FAST.sv ADDER32_LP.sv MULT32_FAST.sv MULT32_LP.sv SHIFTER.sv LOGIC_BLOCK.sv flag_controller.sv pipe_counter.sv c0_calculator.sv conflict_handler.sv}
