...
REM
REM Generated by Vivado on Fri Dec 26 20:09:48 +0300 2025
...
echo "xvlog --incr --relax -L uvm -prj ALU_LPnIDLE_TB_vlog.prj"
call xvlog  --incr --relax -L uvm -prj ALU_LPnIDLE_TB_vlog.prj -log xvlog.log
