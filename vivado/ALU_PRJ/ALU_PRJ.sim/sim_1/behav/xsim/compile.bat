...
REM
REM Generated by Vivado on Thu Jan 01 21:04:12 +0300 2026
...
echo "xvlog --incr --relax -L uvm -prj ALU_specific_TB_vlog.prj"
call xvlog  --incr --relax -L uvm -prj ALU_specific_TB_vlog.prj -log xvlog.log
