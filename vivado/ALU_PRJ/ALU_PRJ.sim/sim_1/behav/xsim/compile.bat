...
REM
REM Generated by Vivado on Sun Dec 28 14:57:37 +0300 2025
...
echo "xvlog --incr --relax -L uvm -prj MULT32_FAST_CT_vlog.prj"
call xvlog  --incr --relax -L uvm -prj MULT32_FAST_CT_vlog.prj -log xvlog.log
