...
REM
REM Generated by Vivado on Sat Jan 03 20:43:35 +0300 2026
...
echo "xvlog --incr --relax -L uvm -prj ALU_FAST_TB_vlog.prj"
call xvlog  --incr --relax -L uvm -prj ALU_FAST_TB_vlog.prj -log xvlog.log
