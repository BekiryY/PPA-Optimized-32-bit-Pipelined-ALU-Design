...
REM
REM Generated by Vivado on Wed Dec 31 11:43:41 +0300 2025
...
echo "xvlog --incr --relax -L uvm -prj ALU_TOP_CT_vlog.prj"
call xvlog  --incr --relax -L uvm -prj ALU_TOP_CT_vlog.prj -log xvlog.log
