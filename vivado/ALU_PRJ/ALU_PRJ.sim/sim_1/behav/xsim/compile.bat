...
REM
REM Generated by Vivado on Wed Dec 31 14:00:29 +0300 2025
...
echo "xvlog --incr --relax -L uvm -prj ADDER32_FAST_TB_vlog.prj"
call xvlog  --incr --relax -L uvm -prj ADDER32_FAST_TB_vlog.prj -log xvlog.log
