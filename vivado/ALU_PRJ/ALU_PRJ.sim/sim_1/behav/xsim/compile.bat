...
REM
REM Generated by Vivado on Sun Dec 28 11:28:10 +0300 2025
...
echo "xvlog --incr --relax -L uvm -prj ALU_Loose_TB_vlog.prj"
call xvlog  --incr --relax -L uvm -prj ALU_Loose_TB_vlog.prj -log xvlog.log
