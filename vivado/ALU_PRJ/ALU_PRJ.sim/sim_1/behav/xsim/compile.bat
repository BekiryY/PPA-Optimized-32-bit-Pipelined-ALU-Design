...
REM
REM Generated by Vivado on Mon Dec 22 13:47:18 +0300 2025
...
echo "xvlog --incr --relax -L uvm -prj ALU_TB_Loose_vlog.prj"
call xvlog  --incr --relax -L uvm -prj ALU_TB_Loose_vlog.prj -log xvlog.log
