...
REM
REM Generated by Vivado on Wed Dec 31 21:32:45 +0300 2025
...
echo "xvlog --incr --relax -L uvm -prj ALU_TOP_vlog.prj"
call xvlog  --incr --relax -L uvm -prj ALU_TOP_vlog.prj -log xvlog.log
